    ...
    <div className="about__container">
      ...
      <div className="about__description">
        <div className="about__intro">
          ...
          <p>There are some information about me down below</p>
        </div>
        <article className="about__education theme">
          ...
          <ul className="theme__list list">
            <li className="list__item item">
              <h4 className="item__header">Gomel City Lyceum</h4>
              <p className="item__description">Physics and maths</p>
            </li>
            <li className="list__item item">
              <h4 className="item__header">Belarusian State University of Informatics and Radioelectronics</h4>
              <div>
                <p className="item__description">The Faculty of Information Technologies and Control.</p>
        ...
        <article className="about__skills theme">
          ...
          <div className="theme__description">HTML5, CSS3, SASS/SCSS, Git, JavaScript, React, Redux, Figma, Photoshop, Ant Design</div>
        </article>
      </div>
    </div>
  </section>
